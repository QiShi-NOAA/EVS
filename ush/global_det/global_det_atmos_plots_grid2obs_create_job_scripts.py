...
base_plot_jobs_info_dict = {
        ...
        'GeoHeight': {'vx_masks': ['GLOBAL', 'NHEM', 'SHEM', 'TROPICS',
                      ...
                      'obs_var_dict': {'name': 'HGT',
                                       'levels': ['P1000', 'P925', 'P850',
                                                  ...
                                                  'P50', 'P20', 'P10', 'P5']},
                     'obs_name': 'ADPUPA'},
        'RelHum': {'vx_masks': ['GLOBAL', 'NHEM', 'SHEM', 'TROPICS', 'CONUS', 'Alaska'],
                   ...
                   'obs_var_dict': {'name': 'RH',
                                    'levels': ['P1000', 'P925', 'P850',
                                               ...
                                               'P10', 'P5']},
                   'obs_name': 'ADPUPA'},
        'SpefHum': {'vx_masks': ['GLOBAL', 'NHEM', 'SHEM', 'TROPICS', 'CONUS', 'Alaska'],
                    ...
                    'obs_var_dict': {'name': 'SPFH',
                                     'levels': ['P1000', 'P925', 'P850',
                                                ...
                                                'P50', 'P20', 'P10', 'P5']},
                    'obs_name': 'ADPUPA'},
        'Temp': {'vx_masks': ['GLOBAL', 'NHEM', 'SHEM', 'TROPICS', 'CONUS', 'Alaska'],
                 ...
                 'obs_var_dict': {'name': 'TMP',
                                  'levels': ['P1000', 'P925', 'P850', 'P700',
                                             ...
                                             'P5']},
                 'obs_name': 'ADPUPA'},
        'UWind': {'vx_masks': ['GLOBAL', 'NHEM', 'SHEM', 'TROPICS', 'CONUS', 'Alaska'],
                  ...
                  'obs_var_dict': {'name': 'UGRD',
                                   'levels': ['P1000', 'P925', 'P850', 'P700',
                                              ...
                                              'P5']},
                  'obs_name': 'ADPUPA'},
        'VWind': {'vx_masks': ['GLOBAL', 'NHEM', 'SHEM', 'TROPICS', 'CONUS', 'Alaska'],
    ...
    'sfc': {
        ...
        'Ceiling': {'vx_masks': ['CONUS', 'CONUS_Central', 'CONUS_East',
                                 'CONUS_South', 'CONUS_West', 'Alaska', 'Appalachia',
...
for sfc_job in list(make_plots_jobs_dict['sfc'].keys()):
    ...
    if sfc_job in ['CAPEMixedLayer', 'CAPESfcBased', 'PBLHeight',
        ...
        make_plots_jobs_dict['sfc'][sfc_job+'_FBAR_OBAR']['vx_masks']=[
            'CONUS', 'CONUS_East', 'CONUS_West', 'CONUS_Central', 'CONUS_South', 'Alaska'
        ]
