#PBS -N jevs_stats_global_det_eagle_solo_atmos_grid2grid_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDMAIL=NO
export KEEPDATA=NO
export job=${PBS_JOBNAME:-jevs_stats_global_det_eagle_solo_atmos_grid2grid}
