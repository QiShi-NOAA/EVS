#PBS -N jevs_stats_global_det_eagle_solo_test_atmos_grid2grid_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDMAIL=NO
export KEEPDATA=NO
export job=${PBS_JOBNAME:-jevs_stats_global_det_eagle_solo_test_atmos_grid2grid}
...
export MODELNAME=eagle_solo_test

export DATAROOT=/lfs/h2/emc/stmp/$USER/evs_test/$envir/tmp
export TMPDIR=$DATAROOT
export COMIN=/lfs/h2/emc/vpppg/noscrub/emc.vpppg/$NET/$evs_ver_2d
export COMOUT=/lfs/h2/emc/vpppg/noscrub/$USER/EVS_aigfs_expr/$NET/$evs_ver_2d/$STEP/$COMPONENT
