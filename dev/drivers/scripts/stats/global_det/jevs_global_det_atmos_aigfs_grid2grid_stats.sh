#PBS -N jevs_global_det_atmos_aigfs_grid2grid_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export job=${PBS_JOBNAME:-jevs_global_det_atmos_aigfs_grid2grid_stats}
...
export config=$HOMEevs/parm/evs_config/global_det/config.evs.${STEP}.${COMPONENT}.${RUN}.${VERIF_CASE}.aigfs
